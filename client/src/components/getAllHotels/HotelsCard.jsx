const HotelsCard = ({ hotel }) => {
  return (
    <div className=" rounded-3xl shadow-sm bg-back-main-color flex-col">
      <img
        src={hotel.bannerImage.data.display_url}
        width="375"
        height="200"
        className="rounded-t-3xl justify-center grid h-80 object-cover w-full"
      ...
      <div className="group p-6 grid z-10">
        <h3
          ...
          className="text-white font-bold sm:text-2xl line-clamp-2"
        >
         {hotel.hotelName}
        </h3>
