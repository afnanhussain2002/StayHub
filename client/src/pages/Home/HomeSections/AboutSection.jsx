  ...
  return (
    <section className="mt-9 max-w-7xl mx-auto flex gap-6 ">
      <div className="flex-1">
        <h3 className="text-back-main-color font-semibold tracking-widest">ABOUT US</h3>

        <h2 className="text-4xl font-semibold py-4">Welcome StayHub Hotel In Street Golapganj</h2>
        ...
        <p className="text-xl">
          ...
          With a passion for unparalleled service and
          memorable experiences, StayHub is your trusted partner in crafting
          unforgettable moments on your journey. Welcome to a world of comfort
          and convenience
        </p>
      </div>
      <div className="flex-1 relative bottom-28">
        ...
        <img
          ...
          alt="hotel"
          className="border-8 w-96 relative right-20 bottom-16"
        />
      </div>
    </section>
  );
